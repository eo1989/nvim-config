...
local function general_overrides()
  highlight.all {
    ...
    { CursorLineNr = { bold = true, fg = P.teal, bg = 'NONE' } },
    ...
    -- Floats
    ---------------------------------------------//
    -- { NormalFloat = { bg = { from = 'NormalFloat', alter = -0.15 } } },
    ...
    -----------------------------------------------------------------------------//
    { CodeBlock = { bg = { from = 'Normal', alter = 0.2 } } },
